...
const T = {
  ar: {
    welcome: (name: string) =>
      `أهلاً وسهلاً فيك${name ? " " + name : ""}! معك إريا من أفورا، وأنا سعيدة جداً بانضمامك لنا. أنا هنا أساعدك توصل للعملاء المثاليين لك. قبل ما نبدأ، ممكن تشاركني رابط موقعك الإلكتروني؟`,
    urlPlaceholder: "https://yourwebsite.com",
    urlLabel: "رابط موقعك الإلكتروني",
    urlButton: "تحليل الموقع →",
    analyzing: "رائع! أنا الحين أحلل موقعك، استنى شوي...",
    confirmPrefix: "تمام، شفت إن موقعك يقدم",
    confirmMid: "لقطاع",
    confirmSuffix: ". هذا صحيح؟",
    confirmYes: "نعم، صحيح ✓",
    confirmNo: "لا، في تعديل",
    giftAnnounce:
      "🎁 ماشاء الله! جهزتلك هدية من أفورا — خمس عملاء مؤهلين مجاناً بناءً على بيزنسك. راح تلاقيهم في الـ CRM حقك الحين!",
    generatingLeads: "جاري تجهيز العملاء المجانيين...",
    freeleadsTitle: "5 عملاء مجاناً — هدية من AVORA 🎁",
    ctaText: "تبي تاخذ خمس عملاء إضافيين؟ بس أجاوب على خمس أسئلة بسيطة معي!",
    ctaButton: "يلا نبدأ! 🚀",
    goToCrm: "روح CRM",
    ...
    goodLead: "👍 عميل مناسب",
    badLead: "👎 مش مناسب",
    replacing: "جاري تجهيز بديل...",
    invalidUrl: "عذراً، ما قدرت أتحقق من الرابط. ممكن تتأكد منه وتعيد المحاولة؟",
    unreachable: "عذراً، ما قدرت أتحقق من الرابط. ممكن تتأكد منه وتعيد المحاولة؟",
    listening: "تفضل، أنا أسمعك...",
    understanding: "فاهمة عليك، شوي وأكمل...",
    dir: "rtl" as const,
  },
  en: {
    welcome: (name: string) =>
