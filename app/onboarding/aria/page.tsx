...
const T = {
  ar: {
    welcome: (name: string) =>
      `أَهْلاً وَسَهْلاً بِيكَ${name ? " " + name : ""}! مَعَاكَ إِرْيَا مِنْ أَفُورَا، وَمَبْسُوطَةٌ جِدَّاً إِنَّكَ انْضَمَّيْتْ لِيْنَا. أَنَا هِنَا أَسَاعِدَكَ تُوصَلْ لِلْعُمَلَا الْمُثَالِيِّينَ لِيكَ. مُمْكِنْ تِدِّيْنِي الْوِيبْ سَايْتْ بِتَاعَكَ؟`,
    urlPlaceholder: "https://yourwebsite.com",
    urlLabel: "الويب سايت بتاعك",
    urlButton: "تحليل الويب سايت →",
    analyzing: "مُمْتَازٌ! أَنَا بَحَلِّلْ الْوِيبْ سَايْتْ بِتَاعَكَ دَلْوَقْتِي...",
    confirmPrefix: "تَمَامٌ، شُفْتُ إِنَّكَ بِتِقَدِّمْ",
    confirmMid: "لِـ",
    confirmSuffix: ". صَحٌّ؟",
    confirmYes: "أَيْوَهْ، صَحٌّ ✓",
    confirmNo: "لَا، فِي تَعْدِيلْ",
    giftAnnounce:
      "🎁 هَدِيَّتَكَ مِنْ أَفُورَا! جَهَّزْتِلَّكَ خَمْسَةْ لِيدْزَ مُؤَهَّلَةٌ مَجَّاناً بِنَاءً عَلَى بِيزْنَسَكَ. هَتِلَاقِيهُمْ فِي السِّي آر إِمْ بِتَاعَكَ دَلْوَقْتِي!",
    generatingLeads: "بَجَهِّزْ الْلِيدْزَ الْمَجَّانِيَّةُ بِتَاعَتَكَ...",
    freeleadsTitle: "5 ليدز مجانية — هدية من AVORA 🎁",
    ctaText: "عَاوِزْ تَاخُدْ خَمْسَةْ لِيدْزَ أَكْتَرْ؟ بَسْ أَجَاوِبْ عَلَى خَمْسَةْ أَسْئِلَةٌ بَسِيطَةٌ مَعَايَا!",
    ctaButton: "يَلَّا نِبْدَأَ! 🚀",
    goToCrm: "روح CRM",
    ...
    goodLead: "👍 ليد مناسب",
    badLead: "👎 مش مناسب",
    replacing: "بَجَهِّزْ لِيدٌ بَدِيلٌ...",
    invalidUrl: "الرابط مش صحيح. لازم يبدأ بـ https:// أو http://",
    unreachable: "مَقْدَرْتِشْ أَوْصَلْ لِلْوِيبْ سَايْتْ دَهْ. تَأَكَّدْ مِنَ الرَّابِطْ وَحَاوِلْ تَانِي.",
    dir: "rtl" as const,
  },
  en: {
    welcome: (name: string) =>
