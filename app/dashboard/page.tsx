...
export default function DashboardPage() {
  ...
  // Determine which tabs are visible based on session type
  ...
  useEffect(() => {
    Promise.all([
      ...
      // Set initial tab based on URL param or role
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Welcome + KPIs — shown for all non-SalesRep */}
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {!isViewer && (
                <div className="flex gap-3">
                  ...
                  {isOwner && (
                    <Button variant="secondary" loading={generating} onClick={handleRegenerate}
        ...
        {/* Tabs — show when there's a report OR for CRM/Team tabs that don't need a report */}
